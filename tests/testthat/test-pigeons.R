test_that("complicated data gets imported correctly (pigeons)", {
  data_list <- import_user_STb(
    event_data = STbayes::pigeon_events,
  ...
  expect_equivalent(data_list$A[1, , , , ], STbayes::pigeon_data_list_TRUE$A_avf)
  expect_equivalent(data_list$A[2, , , , ], STbayes::pigeon_data_list_TRUE$A_dist)
  expect_equivalent(data_list$A[3, , , , ], STbayes::pigeon_data_list_TRUE$A_vor)
  expect_equivalent(data_list$A[4, , , , ], STbayes::pigeon_data_list_TRUE$A_fov)
})

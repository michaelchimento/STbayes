...
# fit the model
fit_social = fit_STb(data_list_user, model_social, parallel_chains = 5, chains = 5, cores = 5, iter=2000, control = list(adapt_delta=0.99))
...
# fit the model
fit_asocial = fit_STb(data_list_user, model_asocial, parallel_chains = 5, chains = 5, cores = 5, iter=2000, control = list(adapt_delta=0.99), fixed_param=T)
